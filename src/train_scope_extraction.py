"""
Train a seq2seq model to extract scope/trigger information as JSON.

Expected field in data: "scope_labels" containing the target JSON object.
Usage:
    python -m src.train_scope_extraction --data data/processed/segments_train.jsonl
"""
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--output_dir", type=Path, default=Path("outputs/scope_extraction"))
